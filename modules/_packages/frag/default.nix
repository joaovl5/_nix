{
  ...
  shared_skills = builtins.path {
    ...
    path = ../../aspects/desktop/ai/_prompts/skills;
  };
  ...
  shared_assets = pkgs.runCommand "frag-shared-assets" {} ''
    ...
    cp -r ${../../aspects/desktop/ai/_prompts/agents} "$shared_root/.code/agents"
    cp -r ${shared_skills} "$shared_root/.code/skills"
    cp ${../../aspects/desktop/ai/_prompts/general/system.md} "$shared_root/.code/AGENTS.md"

    cp -r ${../../aspects/desktop/ai/_prompts/agents} "$shared_root/.omp/agent/agents"
    cp -r ${shared_skills} "$shared_root/.omp/agent/skills"
    cp ${../../aspects/desktop/ai/_prompts/general/system.md} "$shared_root/.omp/agent/SYSTEM.md"
