...
(defun my-elisp-flymake-setup ()
  ...
  (add-hook
   'flymake-diagnostic-functions #'my-elisp-flymake-read-syntax
   nil t)
...
(use
 ...
 :ensure nil
 :bind
 (("C-c x b" . flymake-show-buffer-diagnostics)
  ("C-c x x" . my-flymake-show-diagnostics))
 :hook
 ((emacs-lisp-mode . my-elisp-flymake-setup)
  (flymake-diagnostics-buffer-mode
   . my-flymake-sort-diagnostics-by-severity)
  (flymake-project-diagnostics-mode
   . my-flymake-sort-diagnostics-by-severity)
  (lisp-interaction-mode . my-elisp-flymake-setup))
 :config (my-elisp-flymake-setup-existing-buffers))
...
(use devdocs :ensure t :bind (("C-c c d" . devdocs-search)))
...
(use
 ...
 :config (add-hook 'eldoc-box-buffer-hook #'my-eldoc-box-bind-quit))
...
(use
 ...
 (dolist (mode
          '(emacs-lisp-mode
            lisp-interaction-mode lisp-mode common-lisp-mode))
