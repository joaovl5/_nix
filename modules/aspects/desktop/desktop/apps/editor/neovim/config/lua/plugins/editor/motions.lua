...
do
  ...
  for __25_auto, attrs_26_auto in ipairs({_4_.event("BufEnter"), _4_.keys(_5_.bind("s", _7_, _5_.m("n", "x", "o")), _5_.bind("S", _8_, _5_.m("n", "x", "o")), _5_.bind("r", _9_, _5_.m("o"), _5_.desc("Remote flash"))), _4_.opts(_10_(...))}) do
...
do
  ...
  for __25_auto, attrs_26_auto in ipairs({_11_.keys(_12_.bind("w", _14_, _12_.m("n", "x", "o")), _12_.bind("e", _15_, _12_.m("n", "x", "o")), _12_.bind("b", _16_, _12_.m("n", "x", "o"))), _11_.opts(true)}) do
    for key_27_auto, value_28_auto in pairs(attrs_26_auto) do
      spec_24_auto[key_27_auto] = value_28_auto
    end
  end
...
local function _19_(...)
  ...
  for __25_auto, attrs_26_auto in ipairs({_17_.cmd("Treewalker"), _17_.keys(_18_.bind("<A-[>", _20_, _18_.m("n", "x")), _18_.bind("<A-]>", _21_, _18_.m("n", "x")), _18_.bind("<A-k>", _22_, _18_.m("n", "x")), _18_.bind("<A-j>", _23_, _18_.m("n", "x")), _18_.bind("<A-S-[>", _24_, _18_.m("n", "x")), _18_.bind("<A-S-]>", _25_, _18_.m("n", "x")), _18_.bind("<A-K>", _26_, _18_.m("n", "x")), _18_.bind("<A-J>", _27_, _18_.m("n", "x"))), _17_.opts({})}) do
    for key_27_auto, value_28_auto in pairs(attrs_26_auto) do
      spec_24_auto[key_27_auto] = value_28_auto
    end
  end
