...
local languages = {"css", "dhall", "fennel", "html", "javascript", "jsx", "kanata", "lua", "markdown", "nim", "nix", "python", "rust", "scss", "svelte", "tsx", "typescript", "typespec", "vimdoc"}
do
...
return {{"auipga/hmts.nvim", branch = "patch-1"}, {"m-demare/hlargs.nvim", event = "VeryLazy", opts = {}}}
