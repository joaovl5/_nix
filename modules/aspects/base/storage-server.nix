_: {
  den.aspects.base-storage-server.nixos = {
    config,
    lib,
    pkgs,
    mylib,
  ...
  in
    o.module "storage" (with o; {
      ...
      opts: let
        ...
        graveyard_prune_python = pkgs.python3.withPackages (python_packages: [
          python_packages.cyclopts
        ]);
      in
        o.when cfg.enable {
          ...
          systemd = {
            ...
            services = {
              ...
              storage-graveyard-prune = {
                ...
                serviceConfig = {
                  Type = "oneshot";
                  ExecStart = "${graveyard_prune_python}/bin/python3 ${graveyard_prune_script} --graveyard-root ${cfg.graveyard_root} --retention-days ${toString retention.graveyard_retention_days}";
                };
              };
            };
