...
- **Config consistency:** if a non-default config dir is in play, keep
  `--config /path/to/config/dir` on every command
...
- **Window IDs and args:**
  <https://elkowar.github.io/eww/configuration.html#using-window-arguments-and-ids>
- **`for`:**
