...
in
  ...
  o.module "unit.litellm" (with o; {
    ...
    litellm_config_yaml = write_yaml_from_attrset "litellm_config.yaml" litellm_config;
  in {
    sops.secrets = {
