...
local opts = {{"mouse", "a"}, {"mousescroll", "ver:15,hor:6"}, {"switchbuf", "usetab"}, {"swapfile", false}, {"undofile", true}, {"shada", "'100,<50,s10,:1000,/100,@100,h"}, {"termguicolors", true}, {"updatetime", 1000}, {"timeoutlen", 300}, {"background", "dark"}, {"colorcolumn", "+1"}, {"number", true}, {"relativenumber", true}, {"list", true}, {"listchars", "tab:\194\187 ,trail:\194\183,nbsp:\226\144\163"}, {"fillchars", "eob: ,fold:\226\149\140"}, {"wrap", false}, {"linebreak", true}, {"breakindent", true}, {"breakindentopt", "list:-1"}, {"cursorline", true}, {"cursorcolumn", true}, {"cursorlineopt", "screenline,number"}, {"ruler", false}, {"showmode", false}, {"signcolumn", "yes"}, {"splitbelow", true}, {"splitright", true}, {"splitkeep", "screen"}, {"winborder", "rounded"}, {"foldlevel", 10}, {"foldmethod", "indent"}, {"foldnestmax", 10}, {"foldtext", ""}, {"spelloptions", "camel"}, {"virtualedit", "block"}, {"iskeyword", "@,48-57,_,192-255,-"}, {"scrolloff", 10}, {"complete", ".,w,b,kspell"}, {"completeopt", "menuone,noselect,fuzzy,nosort"}, {"autoindent", true}, {"smartindent", true}, {"expandtab", true}, {"shiftwidth", 2}, {"tabstop", 2}, {"formatlistpat", "^\\s*[0-9\\-\\+\\*]\\+[\\.\\)]*\\s\\+"}, {"formatoptions", "rqnl1"}, {"ignorecase", true}, {"incsearch", true}, {"smartcase", true}}
do
  local set_opt
