...
return {
	{ "windwp/windline.nvim", config = _8_, event = "VeryLazy" },
	{
		"nanozuki/tabby.nvim",
		event = "VeryLazy",
		keys = {
			{ "<leader>qr", _9_, desc = "Rename" },
	...
	{
		"b0o/incline.nvim",
		opts = { window = { padding = 0, margin = { horizontal = 1, vertical = 0 } }, render = incline_render },
	},
}
