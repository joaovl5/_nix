...
return {{"nvimtools/none-ls.nvim", dependencies = {"nvim-lua/plenary.nvim", "nvimtools/none-ls-extras.nvim"}, opts = _5_}, {"neovim/nvim-lspconfig", config = mk_lsp, dependencies = {"b0o/schemastore.nvim", {":artemave/workspace-diagnostics.nvim", opts = {}}}}}
