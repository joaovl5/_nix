...
local function _5_()
  ...
  no = _6_
  return {sources = {nu.formatting.alejandra, nu.diagnostics.statix, nu.code_actions.statix, nu.diagnostics.deadnix, nu.formatting.prettierd, no("formatting.jq"), no("diagnostics.eslint_d"), no("code_actions.eslint_d")}}
end
return {{"nvimtools/none-ls.nvim", dependencies = {"nvim-lua/plenary.nvim", "nvimtools/none-ls-extras.nvim"}, opts = _5_}, {"neovim/nvim-lspconfig", dependencies = {"b0o/schemastore.nvim", {":artemave/workspace-diagnostics.nvim", opts = {}}}}}
