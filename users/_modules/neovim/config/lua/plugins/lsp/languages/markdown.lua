...
local function _1_()
  ...
  local name_2_auto = require("markview")
  local fun_3_auto = name_2_auto.setup
  return fun_3_auto({preview = {filetypes = filetypes, icon_provider = "mini", ignore_buftypes = {}}, markdown = {list_items = {wrap = true, shift_width = 2, marker_minus = {text = "\226\137\149", wrap = true, add_padding = false}}}})
end
