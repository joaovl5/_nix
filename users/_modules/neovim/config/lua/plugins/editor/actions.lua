...
return {
		...
		dependencies = {
			"nvim-lua/plenary.nvim",
			{
				...
				opts = {
					...
					ignore = { clients = { "ruff", "dev-tools", "nil", "typescript-tools", "marksman" } },
				},
			},
		},
		event = "LspAttach",
	...
	},
	{
		"folke/trouble.nvim",
		cmd = "Trouble",
		dependencies = { { "folke/todo-comments.nvim", cmd = "TodoTrouble", opts = {} } },
		opts = {},
		keys = {
			{ "<leader>xx", "<cmd>Trouble diagnostics toggle<cr>", desc = "Trouble (global)" },
			{ "<leader>xX", "<cmd>Trouble diagnostics toggle filter.buf=0<cr>", desc = "Trouble (buffer)" },
			{ "<leader>xt", "<cmd>TodoTrouble<cr>", desc = "TODOs" },
			{ "<leader>xl", "<cmd>Trouble loclist toggle<cr>", desc = "Trouble locations" },
