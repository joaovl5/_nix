...
wk.add({
	...
	km("<leader>aa", { desc = "Actions", mode = { "n", "v" } }, ":CodeCompanionActions<CR>"),
	km("<leader>ac", { desc = "Chat", mode = { "n", "v" } }, ":CodeCompanionChat Toggle<CR>"),
	km("<leader>ar", { desc = "Run command", mode = { "n", "v" } }, ":CodeCompanionCmd<CR>"),
	km("<leader>al", { desc = "Inline Assist", mode = { "n", "v" } }, ":CodeCompanion<CR>"),
})
wk.add({
	...
	km("<leader>nx", { desc = "Extract into note", mode = { "v" } }, ":Obsidian extract_note<CR>"),
	km("<leader>na", { desc = "Link new note", mode = { "v" } }, ":Obsidian link_new<CR>"),
...
local function _41_(args)
	...
	return wk.add({
		...
		km("<leader>bS", { desc = "Make focused dir CWD", buffer = buf_id }, set_cwd),
