...
do
  ...
  local spec_24_auto = {}
  for __25_auto, attrs_26_auto in ipairs({_1_.version("*"), _1_.opts(true)}) do
    for key_27_auto, value_28_auto in pairs(attrs_26_auto) do
      spec_24_auto[key_27_auto] = value_28_auto
    end
  end
  spec_24_auto[1] = "nvim-mini/mini.ai"
  _3_ = spec_24_auto
end
local _6_
do
  ...
  for __25_auto, attrs_26_auto in ipairs({_4_.version("*"), _4_.keys(_5_.group("buffer", _5_.bind("d", _7_, _5_.desc("Delete buffer")))), _4_.opts({silent = true})}) do
    for key_27_auto, value_28_auto in pairs(attrs_26_auto) do
      spec_24_auto[key_27_auto] = value_28_auto
    end
  end
  spec_24_auto[1] = "nvim-mini/mini.bufremove"
  _6_ = spec_24_auto
end
local _10_
do
  ...
  local spec_24_auto = {}
  for __25_auto, attrs_26_auto in ipairs({_8_.version("*"), _8_.opts(true)}) do
    for key_27_auto, value_28_auto in pairs(attrs_26_auto) do
      spec_24_auto[key_27_auto] = value_28_auto
    end
  end
  spec_24_auto[1] = "nvim-mini/mini.extra"
  _10_ = spec_24_auto
end
local _13_
do
  ...
  local spec_24_auto = {}
  for __25_auto, attrs_26_auto in ipairs({_11_.version("*"), _11_.event("VeryLazy"), _11_.opts({modes = {command = true}})}) do
    for key_27_auto, value_28_auto in pairs(attrs_26_auto) do
      spec_24_auto[key_27_auto] = value_28_auto
    end
  end
  spec_24_auto[1] = "nvim-mini/mini.pairs"
  _13_ = spec_24_auto
end
local _16_
do
  ...
  for __25_auto, attrs_26_auto in ipairs({_14_.version("*"), _14_.config(_17_)}) do
    for key_27_auto, value_28_auto in pairs(attrs_26_auto) do
      spec_24_auto[key_27_auto] = value_28_auto
    end
  end
  spec_24_auto[1] = "nvim-mini/mini.misc"
  _16_ = spec_24_auto
end
local function _20_(...)
  ...
  spec_24_auto[1] = "nvim-mini/mini.basics"
  return spec_24_auto
end
