...
local formatters = {alejandra = {command = "alejandra"}, kdlfmt = {command = "kdlfmt", args = {"format", "--kdl-version", "v1", "--stdin"}}, nix_fmt = {command = "nix", args = {"fmt"}}, prettierd = {command = "prettierd"}, sane_fnlfmt = {command = "fnlfmt"}}
