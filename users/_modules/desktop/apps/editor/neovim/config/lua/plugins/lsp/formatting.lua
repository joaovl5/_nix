...
local default_formatters_by_ft = {["*"] = {"keep-sorted"}, _ = {"trim_whitespace", "trim_newlines", "squeeze_blanks"}, dockerfile = {"dockerfmt"}, fennel = {"sane_fnlfmt"}, fish = {"fish_indent"}, handlebars = {"prettierd"}, janet = {"jandent", "squeeze_blanks"}, javascript = {"prettierd"}, json = {"jsonfmt"}, kdl = {"kdlfmt"}, kulala = {"kulala-fmt"}, lua = {"stylua"}, markdown = {"rumdl"}, nim = {"nph"}, nix = {"alejandra"}, python = {"ruff_fix", "ruff_format", "ruff_organize_imports"}, rust = {"rustfmt"}, sh = {"shfmt"}, sql = {"sqruff"}, toml = {"taplo"}, typescript = {"prettierd"}, typescriptreact = {"prettierd"}, yaml = {"yamlfmt"}}
