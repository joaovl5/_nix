...
return {"folke/snacks.nvim", opts = {bigfile = {enabled = true}, quickfile = {enabled = true}, notify = {enabled = true}, notifier = {enabled = true, width = {min = 50, max = 0.4}, height = {min = 1, max = 0.6}, margin = {top = 2, right = 1, bottom = 0}, padding = true, gap = 0, sort = {"level", "added"}, level = vim.log.levels.TRACE, icons = {error = "\239\129\151 ", warn = "\239\129\177 ", info = "\239\129\154 ", debug = "\239\134\136 ", trace = "\238\182\166 "}, keep = _1_, style = "minimal", top_down = true, date_format = "%R", more_format = " \226\134\147 %d lines ", refresh = 50}, terminal = {}, picker = {prompt = "> ", show_delay = 1000, layout = {preset = "vscode", layout = {width = 0.7, row = 10, border = "none"}}, sources = _2_, matcher = {fuzzy = true, smartcase = true, cwd_bonus = true, frecency = true, history_bonus = true}, ui_select = "true", win = {input = {keys = keyset}, list = {keys = keyset}, preview = {keys = keyset}}, previewers = {diff = {style = "fancy", cmd = {"delta"}, wo = {breakindent = true, wrap = true, linebreak = true, showbreak = ""}}}}, dashboard = {preset = {header = _G.header}, sections = {{section = "header"}, {section = "keys", gap = 1, padding = 1}, {section = "startup"}}}, styles = {input = {border = false}, scratch = {border = false}, split = {position = "bottom", height = 25, border = false}, float = {border = true, width = 0.99, height = 0.99}}, input = {enabled = true}, image = {enabled = true}}}
