...
local function _6_(...)
  ...
  local spec_21_auto = {}
  for __22_auto, attrs_23_auto in ipairs({_4_.deps({"SmiteshP/nvim-navic", "MunifTanjim/nui.nvim", "numToStr/Comment.nvim"}), _4_.cmd("Navbuddy"), _4_.keys(_5_.group("code", _5_.bind("n", _5_.cmd("Navbuddy"), _5_.desc("Navbuddy")))), _4_.opts({window = {border = "rounded", size = "60%"}, lsp = {auto_attach = true}})}) do
    for key_24_auto, value_25_auto in pairs(attrs_23_auto) do
      spec_21_auto[key_24_auto] = value_25_auto
    end
  end
  spec_21_auto[1] = "SmiteshP/nvim-navbuddy"
  return spec_21_auto
end
