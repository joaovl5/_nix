...
for __24_auto, attrs_25_auto in ipairs({_1_.dependencies({_5_(...)}), _1_.ft("python"), _1_.keys(_2_.bind(_2_.l("cv"), _2_.cmd("VenvSelect"), _2_.desc("Pick virtual env"))), _1_.opts({})}) do
  for key_26_auto, value_27_auto in pairs(attrs_25_auto) do
