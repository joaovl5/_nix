...
for __24_auto, attrs_25_auto in ipairs({_1_.version("*"), _1_.keys(_2_.bind(_2_.l("E"), _3_, _2_.desc("Explore root")), _2_.bind(_2_.l("e"), _4_, _2_.desc("Explore at file"))), _1_.opts({windows = {preview = true}, width_focus = 40, width_nofocus = 30, max_number = 3, mappings = mappings})}) do
  for key_26_auto, value_27_auto in pairs(attrs_25_auto) do
    spec_23_auto[key_26_auto] = value_27_auto
  end
end
spec_23_auto[1] = "nvim-mini/mini.files"
return spec_23_auto
