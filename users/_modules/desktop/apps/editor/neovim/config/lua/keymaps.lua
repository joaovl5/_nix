...
wk.add({km("<leader>b", {group = "Buffer"}), km("<leader>bb", {desc = "Toggle scratch"}, _18_), km("<leader>bB", {desc = "Pick scratch"}, _19_), km("<leader>bd", {desc = "Delete buffer"}, "<cmd>lua MiniBufremove.delete()<CR>")})
local function _20_()
...
wk.add({km("<leader>f", {group = "Fuzzy"}), km("<leader>f:", {desc = "':' history"}, _20_), km("<leader>fb", {desc = "Buffers"}, _21_), km("<leader>fr", {desc = "Recent"}, _22_), km("<leader>fp", {desc = "Projects"}, _23_), km("<leader>fd", {desc = "Diagnostics"}, _24_), km("<leader>fh", {desc = "Help Tags"}, _25_), km("<leader>fm", {desc = "Man pages"}, _26_), km("<leader>fH", {desc = "Highlights"}, _27_), km("<leader>fs", {desc = "Symbols"}, _28_), km("<leader>fS", {desc = "Symbols (buffer)"}, _29_), km("<leader><leader>", {desc = "Fuzzy Files"}, _30_), km("<leader>.", {desc = "Fuzzy Files (buffer dir)"}, _31_), km("<leader>/", {desc = "Live Grep"}, _32_), km("<leader>\\", {desc = "Zoxide"}, "<Cmd>Telescope zoxide list<CR>")})
local function _33_()
  return toggle_term("lazygit", "lazygit")
end
wk.add({km("<leader>g", {group = "Git"}), km("<leader>go", {desc = "Toggle Overlay"}, "<cmd>lua MiniDiff.toggle_overlay()<CR>"), km("<leader>gg", {desc = "Lazygit"}, _33_)})
local function _34_()
...
wk.add({km("<leader>c", {group = "Code"}), km("<leader>ca", {desc = "Actions"}, _34_), km("<leader>cf", {desc = "Format"}, _35_), km("<leader>cH", {desc = "Toggle inlay hints"}, _36_), km("<leader>cr", {desc = "Rename"}, vim.lsp.buf.rename), km("<leader>cd", {desc = "Diagnostic"}, vim.diagnostic.open_float), km("<leader>cn", {desc = "Navbuddy"}, "<cmd>Navbuddy<CR>"), km("<leader>cg", {desc = "Neogen"}, "<cmd>Neogen<CR>"), km("K", {desc = "Hover"}, _37_), km("gI", {desc = "Implementations"}, "<cmd>Glance implementations<CR>"), km("gr", {desc = "References"}, "<cmd>Glance references<CR>"), km("gd", {desc = "Definitions"}, "<cmd>Glance definitions<CR>"), km("gt", {desc = "Type Definitions"}, "<cmd>Glance type_definitions<CR>")})
local function _38_()
...
wk.add({km("<leader>x", {group = "Diagnostics"}), km("<leader>xm", {desc = "Messages (noice)"}, "<cmd>NoiceAll<CR>"), km("<leader>xM", {desc = "Messages"}, "<cmd>messages<CR>"), km("<leader>xp", {desc = "Populate diagnostics"}, _40_)})
local function _41_()
...
wk.add({km("<leader>d", {group = "Debug"}), km("<leader>ds", {group = "Session"}), km("<leader>dsn", {desc = "New Session"}, ":DapNew<CR>"), km("<leader>dsc", {desc = "Continue Session"}, ":DapContinue<CR>"), km("<leader>db", {desc = "Breakpoint"}, ":DapToggleBreakpoint<CR>"), km("<leader>dj", {desc = "Step over"}, ":DapStepOver<CR>"), km("<leader>dl", {desc = "Step into"}, ":DapStepInto<CR>"), km("<leader>dr", {desc = "Repl"}, ":DapToggleRepl<CR>"), km("<leader>de", {desc = "Eval under cursor"}, _41_), km("<leader>dx", {desc = "Eval expression"}, _42_), km("<leader>dd", {desc = "Toggle UI"}, _44_)})
wk.add({km("<leader>a", {group = "CodeCompanion"}), km("<leader>aa", {desc = "Actions", mode = {"n", "v"}}, ":CodeCompanionActions<CR>"), km("<leader>ac", {desc = "Chat", mode = {"n", "v"}}, ":CodeCompanionChat Toggle<CR>"), km("<leader>ar", {desc = "Run command", mode = {"n", "v"}}, ":CodeCompanionCmd<CR>"), km("<leader>al", {desc = "Inline Assist", mode = {"n", "v"}}, ":CodeCompanion<CR>")})
local function _45_()
