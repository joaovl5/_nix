...
local function setup_blink()
	...
	do
		...
		_10_ = {
			...
			providers = { dap = { name = "dap", module = "blink.compat.sources", enabled = _11_ } },
		}
	end
	return blink.setup({
		keymap = {
			preset = "none",
			["<Tab>"] = { _8_, "snippet_forward", "fallback" },
		...
		appearance = {
			...
			kind_icons = {
				Text = "\226\156\182 ",
				Method = "\226\151\135 ",
				Function = "\226\150\189 ",
				Constructor = "\226\151\136 ",
				Field = "\240\159\156\130 ",
				Variable = "\226\156\180 ",
				Class = "\239\138\159 ",
				Interface = "\239\146\191 ",
				Struct = "\243\176\174\139 ",
				Module = "\243\176\174\139 ",
				Unit = "\240\159\156\130 ",
				Value = "\240\159\156\130 ",
				Enum = "\240\159\156\149 ",
				EnumMember = "\240\159\156\150 ",
				Keyword = "\240\159\158\159 ",
				Constant = "\226\151\175 ",
				Snippet = "\240\159\156\184 ",
				Color = "\226\152\133 ",
				File = "\240\157\132\158 ",
				Reference = "\240\159\157\191 ",
				Folder = "\240\157\132\161 ",
				Event = "\240\159\157\167 ",
				Operator = "\240\159\157\142 ",
				TypeParameter = "\240\159\157\138 ",
			},
		},
		completion = {
			...
			documentation = {
				...
				window = {
					border = "none",
					direction_priority = { menu_south = { "e", "w", "s" }, menu_north = { "e", "w", "n" } },
				},
			},
			menu = {
				border = "none",
				...
				draw = {
					padding = 1,
					gap = 1,
					components = { label = comp_label, kind_icon = comp_icon, kind = comp_kind },
		...
		signature = {
			...
			window = { min_width = 1, max_width = 200, max_height = 30, border = "none" },
		},
