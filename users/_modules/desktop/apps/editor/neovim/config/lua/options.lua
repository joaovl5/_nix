...
local opts = {
	...
	{ "relativenumber", true },
	{ "list", true },
	{ "listchars", "tab:\194\187 ,trail:\194\183,nbsp:\226\144\163" },
	{ "fillchars", "eob: ,fold:\226\149\140" },
	{ "wrap", false },
	{ "linebreak", true },
	{ "breakindent", true },
...
diagnostic_opts = {
	...
	signs = { priority = 9999, severity = { min = "WARN", max = "ERROR" }, text = _5_ },
	underline = { severity = { "ERROR" } },
	virtual_text = { source = "if_many", spacing = 2, current_line = true, severity = { "ERROR" } },
