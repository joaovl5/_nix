...
diagnostic_opts = {severity_sort = true, float = {border = "rounded", source = "if_many"}, signs = {priority = 9999, severity = {min = "WARN", max = "ERROR"}, text = _6_}, underline = {severity = {"ERROR"}}, virtual_text = {source = "if_many", spacing = 2, current_line = true, severity = {"ERROR"}}, update_in_insert = false, virtual_lines = false}
local function _7_()
...
return v_2fautocmd("FileType", {desc = "Proper 'formatoptions'", callback = _8_})
